...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "nagging-problem",
        label: "Do repairs around the house",
        detail: "There is something not working right, and you want to figure out why and get it fixed.",
        scores: even(2, 1, 4, 0),
      },
    ],
  },
  ...
  },
  {
    ...
    prompt: "What bothers you most in a group project?",
    helper: "Pick the option that would drive you the craziest.",
    options: [
      {
        id: "too-many-steps",
        label: "Everything takes way more steps than it needs to",
        detail: "The process is way more complicated than it has to be.",
        scores: even(3, 1, 0, 2),
      },
      {
        id: "no-owner",
        label: "Nobody knows who is doing what",
        detail: "Work keeps slipping through the cracks because ownership is not clear.",
        scores: even(0, 0, 1, 4),
      },
      {
        id: "no-truth",
        label: "People argue opinions instead of facts",
        detail: "Everyone has a take, but nobody checks what is actually true.",
        scores: even(0, 4, 1, 1),
      },
      {
        id: "mystery-failure",
        label: "Something breaks and no one knows why",
        detail: "It just stops working, and nobody can explain what happened.",
        scores: even(3, 1, 3, 0),
      },
    ],
  },
